...
export function destroyerCoordinates(board, occupiedArr){
    ...
    while(!foundCoord){
        ...
        if(orientation == 0) {
            ...
            if(startSpace[1] < 8){
                ...
                startArray = [startSpace, board[random + 1].coordinates]
            ...
            if(startSpace[0] < 8){
                //Create an array containing the coordinates of each space that the piece will occupy
                startArray = [startSpace, board[random + 8].coordinates]
