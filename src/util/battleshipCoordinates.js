...
//for placing the battleship piece on the board

//Export function and take board as a parameter
export function battleshipCoordinates(board){
    ...
    while(!foundCoord){
        ...
        if(orientation == 0) {
            ...
            if(startSpace[1] < 6){
                ...
                startArray = [startSpace, board[random + 1].coordinates, board[random + 2].coordinates, board[random + 3].coordinates]
                
                //Set foundCoord to true since viable coordinates have been found
                foundCoord = true;
            }
        } else {
            ...
            if(startSpace[0] < 6){
                //Create an array containing the coordinates of each space that the piece will occupy
                startArray = [startSpace, board[random + 8].coordinates, board[random + 16].coordinates, board[random + 24].coordinates]
